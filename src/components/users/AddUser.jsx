    ...
    return (
        <section className={styles.container}>
            <div className={styles.block_container}>
                ...
                <button className={styles.button} onClick={onClickSubmit}>Create new link</button>
            </div>
            <div >
                <input className={styles.input_link} type="text" value={link} />
                <button className={`${styles.button_space} ${styles.button}`} onClick={() => { navigator.clipboard.writeText(link) }}>Copy</button>
            </div>
